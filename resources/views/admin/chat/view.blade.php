                                ...
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    @foreach($chats as $chat)
                                        <tr>
                                            ...
                                            <td>{{$chat->shoppr->name??''}}</td>
                                            <td>{{date('d-m-Y', strtotime($chat->getRawOriginal('created_at')))}}</td>
                                            <td>
                                                <a href="{{route('order.chats.details',['id'=>$chat->id])}}" class="btn btn-info">Details</a><br><br>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
