                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Shoppr Daily Travel Add</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form role="form" method="post" enctype="multipart/form-data" action="{{route('dailytravel.store')}}">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="shoppr_id" required>
                                                    @foreach($shopprs as $shoppr)
                                                        <option value="{{$shoppr->id}}">{{$shoppr->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="km" class="form-control" id="exampleInputEmail1" placeholder="Enter Km" step="any" min="0">
                                            </div>
                                        </div>
